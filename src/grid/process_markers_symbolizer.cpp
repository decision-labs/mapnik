...
// <<<<<<< HEAD (did this because I needed to check if I can compile with `this->metrics_` from merge conflict)
...
// =======
//     using g_context_type = detail::grid_markers_renderer_context<svg_renderer_type,
//                                                                  renderer_type,
//                                                                  buf_type,
//                                                                  grid_rasterizer,
//                                                                  buffer_type>;
//     g_context_type renderer_context(feature, render_buf, *ras_ptr, pixmap_, this->metrics_);
// >>>>>>> mapnik-v3.0.24-v3.0.15-carto
